...
const SourceLinks: React.FC<SourceLinksProps> = ({ sources }) => {
    ...
    return (
        <div className="mt-10 p-6 bg-[#1A1A1A] border border-gray-800 rounded-xl">
            <h4 className="text-lg font-bold text-gray-200 mb-4">Data Sources</h4>
                    ...
                    source.maps && (
                        <li key={index} className="flex items-center">
                            ...
                            <a
                                ...
                                className="text-gray-400 hover:underline hover:text-[#C0A062] transition-colors truncate"
